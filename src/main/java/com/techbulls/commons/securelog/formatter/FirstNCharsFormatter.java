...
/**
 * <h2>FirstNCharsFormatter</h2>
 * A {@link ValueFormatter} that reveals the first N characters of a value and masks the rest
 ...
 * controls how many leading characters are revealed. For example, a {@code secureValue} of
 * {@code "XXXX"} (4 characters) reveals the first 4 characters.
 * <p>
 ...
 * @since 0.3
 */
public final class FirstNCharsFormatter implements ValueFormatter {

    /** Creates a new {@code FirstNCharsFormatter} instance. */
    public FirstNCharsFormatter() {
    }

    /**
     * Reveals the first N characters of the value (where N = {@code secureValue.length()})
     * and masks the remaining trailing characters with asterisks.
     *
     * @param value       the original field value
     * @param secureValue the mask string whose length determines how many leading characters
